...
const Registration = () => {
    ...
    return (
        // <div className="card shadow-sm mh-100">
        //     <div className='card-header'>Ka Qabashada</div>
        ...
        //                     <input className='form-control' id='received_by' type='text' value={sender}
        //                            onChange={e => setSender(e.target.value)}/>
        //                 </div>
        //                 <div className='form-group flex-grow-1'>
        //                     <label htmlFor="service">Service :</label>
        //                     <select className='form-control' id='service' value={service} onChange={e => {
        ...
        //                 <button className='btn btn-danger' onClick={handleNext}>Save & Next</button>
        //                 <button className='btn btn-warning ml-4' type='reset'>Reset</button>
        //             </div>
        //         </form>
        //     </div>
        // </div></div>
                    ...
                    <div className='card-body'>
                        <Form className='pl-4 pr-4'>
                            ...
                            <div className='form-group'>
                                <div className='d-flex justify-content-between'>
                                    ...
                                    <ErrorMessage name='phone'>
                                        {error => {
                                            return <span className='mt-1 text-right text-danger'>{error} *</span>
                                        }}
                                    </ErrorMessage>
                                </div>
                                <div className="input-group p-0">
                            ...
                            <div className='form-group'>
                                ...
                                <Field component='select' name='service' value='1' className='form-control' id='service'>
                                    <option disabled>Choose...</option>
                                    <option value='0'>Isku Bedel</option>
                                    <option value='1'>Ka Iibsasho</option>
                                    <option value='2'>U Iibin</option>
